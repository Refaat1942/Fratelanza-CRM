...
export const FEATURE_GROUPS: { id: string; en: string; ar: string; keys: FeatureKey[] }[] = [
  ...
  {
    id: "medical",
    en: "Medical / Clinic (core)",
    ar: "العيادة الطبية (أساسي)",
    keys: [
      "medical",
      "medical_patients",
      "medical_appointments",
...
export const FEATURE_LABELS: Record<FeatureKey, { en: string; ar: string }> = {
  ...
  medical: { en: "Medical master switch", ar: "تفعيل النظام الطبي" },
  medical_patients: { en: "Patients registry", ar: "سجل المرضى" },
  medical_appointments: { en: "Appointments", ar: "المواعيد" },
  medical_visits: { en: "Clinical visits", ar: "الزيارات السريرية" },
  ...
  medical_procedures: { en: "Procedures catalog", ar: "كتالوج الإجراءات" },
  medical_doctor_availability: { en: "Doctor availability", ar: "ساعات الأطباء" },
  clinic_staff: { en: "Clinic Staff (doctors / nurses)", ar: "طاقم العيادة (أطباء / تمريض)" },
  physiotherapy: { en: "Physiotherapy (assessments · sessions · plans)", ar: "العلاج الطبيعي (تقييم · جلسات · خطط)" },
  clinical_nutrition: { en: "Clinical nutrition (assessments · meal plans)", ar: "التغذية العلاجية (تقييم · خطط غذائية)" },
