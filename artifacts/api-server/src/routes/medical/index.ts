...
import prescriptionTemplatesRouter from "./prescription-templates";
import specializationCatalogRouter from "./specialization-catalog";
...
router.use(specializationCatalogRouter);
